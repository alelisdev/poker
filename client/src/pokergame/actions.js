...
export const TN_FETCH_LOBBY_INFO = "TN_FETCH_LOBBY_INFO";
export const RECEIVE_LOBBY_INFO = "RECEIVE_LOBBY_INFO";
export const TN_RECEIVE_LOBBY_INFO = "TN_RECEIVE_LOBBY_INFO";
export const PLAYERS_UPDATED = "PLAYERS_UPDATED";
export const TN_PLAYERS_UPDATED = "TN_PLAYERS_UPDATED";
...
export const TN_TABLES_UPDATED = "TN_TABLES_UPDATED";
